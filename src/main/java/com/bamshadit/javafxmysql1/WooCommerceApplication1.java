...
public class WooCommerceApplication1 extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(WooCommerceApplication1.class.getResource("load-all-customers.fxml"));
        //https://stackoverflow.com/questions/37200845/how-to-switch-scenes-in-javafx
        //FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("hello-view.fxml"));
        //Scene scene = new Scene(fxmlLoader.load(), 720, 540); //for load-order
